...
const translations: Translations = {
  en: {
    ...
    "venues.searchBar.venueName": "Venue Name",
    "venues.searchBar.venueNamePlaceholder": "Search for a venue",
    "search.venueName": "Search for a venue",
  ...
  "sq": {
    ...
    "business.venueBookings.basePrice": "Cmimi i ambientit",
    ...
    "business.venueTypes.outdoorSpace": "Ambienti i Jashtëm",
    ...
    "business.sidebar.venue-bookings": "Rezervime Ambientesh",
    ...
    "business.bookings.venuesOverview": "Permbledhje e Ambienteve",
    "business.bookings.venuePricing": "Cimi i Ambientit",
    "business.bookings.venueBasePrice": "Cmimi baze",
    "business.bookings.venueTotalCost": "Cmimi total i ambientit",
    ...
    "dashboard.venueDetails": "Detajet e Ambientit",
    ...
    "dashboard.venuePrice": "Çmimi i Ambientit",
    "dashboard.serviceFee": "Tarifa e Shërbimit",
    "dashboard.total": "Totali",
    "favorites.description": "Shiko dhe menaxho ambientet dhe shërbimet e preferuara",
    "favorites.venues": "Ambientet",
    "favorites.services": "Shërbimet",
    "favorites.noVenues": "Asnjë ambient e preferuar",
    "favorites.noVenuesDescription": "Nuk ke shtuar asnjë ambient te të preferuarat.",
    "favorites.browseVenues": "Shfleto Ambientet",
    ...
    "hero.subtitle": "Zbuloni dhe rezervoni ambiente unike për takime, festime, prodhime dhe më shumë.",
    "search.location": "Ku",
    "search.date": "Kur",
    ...
    "venues.subheading": "Zbuloni dhe rezervoni ambientet unike për takime, festime, prodhime dhe më shumë.",
    ...
    "business.venues.editVenueDescription": "Përshkrimi i Ambientit",
    "business.venues.name": "Emri i Ambientit",
    "business.venues.description": "Përshkrimi",
    "business.venues.type": "Lloji i Ambientit",
    ...
    "nav.logout": "Dil",
    "business.venues.venueType": "Lloji i Ambientit",
    "business.venues.noVenuesFound": "Nuk u gjetën ambientet",
    "business.venues.createFirstVenue": "Krijo ambientin tënde të parë",
    "business.venues.noActiveVenues": "Asnjë ambient aktive",
    "business.venues.activateVenues": "Aktivizo ambientet",
    "business.venues.noInactiveVenues": "Asnjë ambient joaktive",
    "business.venues.allVenuesActive": "Të gjitha ambientet janë aktive",
    "business.venues.noFeaturedVenues": "Asnjë ambient e veçuar",
    "business.venues.markVenuesFeatured": "Shëno ambientet si të veçuara",
    ...
    "business.common.createVenue": "Krijo Ambient",
    ...
    "business.bookings.venueType": "Lloji i Ambientit",
    ...
    "help.venue": "Ndihmë për Ambienti",
    ...
    "help.faqTitle4": "Mbështetje për Ambienti",
    ...
    "business.venues.viewVenueDetails": "Shiko Detajet e Ambientit",
    "business.venues.blockDates": "Blloko Datat",
    "business.venues.unblockDates": "Zhblloko Datat",
    "business.venues.blockDatesHelp": "Zgjidh datat që dëshiron të bllokosh për këtë ambient.",
    "business.venues.noDatesSelected": "Asnjë datë nuk është zgjedhur",
    "business.venues.availabilityHelp": "Shëno datat si të disponueshme ose të bllokuara për të menaxhuar disponueshmërinë e ambientit.",
    ...
    "venueBook.venueTotal": "Totali i Ambientit",
