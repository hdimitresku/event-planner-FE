...
const translations: Translations = {
  en: {
    ...
    "business.services.confirmDelete": "Confirm Delete",
    "business.services.viewDetails": "View Details",
    "business.services.editDescription": "Edit Service Description",
    "business.services.name": "Service Name",
    "business.services.description": "Service Description",
    "business.services.type": "Service Type",
    "business.services.selectType": "Select Type",
    "business.services.pricingOptions": "Pricing Options",
    "business.services.optionName": "Option Name",
    "business.services.optionDescription": "Option Description",
    "business.services.price": "Price",
    "business.services.priceType": "Price Type",
    "business.services.selectPriceType": "Select Price Type",
    "business.services.markAsPopular": "Mark as Popular",
    "business.services.addOption": "Add Option",
    "business.services.search": "Search",
    // Service creation
...
=======
    ...
    "business.venues.editVenueDescription": "Update venue details below",
    "business.venues.name": "Stunning Loft Space with City Views",
    "business.venues.description": "This stunning loft space offers breathtaking views of the city skyline. With floor-to-ceiling windows, exposed brick walls, and modern amenities, it's perfect for photoshoots, corporate events, and intimate gatherings.",
    "business.venues.type": "Type",
    "common.hourly": "Hourly",
    "business.venues.minCapacity": "Minimum Capacity",
    "business.venues.maxCapacity": "Maximum Capacity",
    "business.venues.recommendedCapacity": "Recommended Capacity",
    "business.venues.amenities": "Amenities",
    ...
    "venues.amenities.av_equipment": "AV Equipment",
>>>>>>> Stashed changes
    // Home page
...
>>>>>>> Stashed changes
  ...
  "sq": {
    ...
    "business.common.addPhoto": "Shto Foto",
    "business.common.active": "Aktiv",
    "business.common.inactive": "Joaktiv",
    "business.common.all": "Të Gjitha",
    ...
    "business.pricing.type": "Lloji i Çmimit",
    ...
    "business.services.confirmDelete": "Konfirmo Fshirjen",
    "business.services.viewDetails": "Shiko Detajet",
    "business.services.editDescription": "Përditëso Përshkrimin e Shërbimit",
    "business.services.name": "Emri i Shërbimit",
    "business.services.description": "Përshkrimi i Shërbimit",
    "business.services.type": "Lloji i Shërbimit",
    "business.services.selectType": "Zgjidh Llojin",
    "business.services.pricingOptions": "Opsionet e Çmimit",
    "business.services.optionName": "Emri i Opsionit",
    "business.services.optionDescription": "Përshkrimi i Opsionit",
    "business.services.price": "Çmimi",
    "business.services.priceType": "Lloji i Çmimit",
    "business.services.selectPriceType": "Zgjidh Llojin e Çmimit",
    "business.services.markAsPopular": "Shëno si e Popullarizuar",
    "business.services.addOption": "Shto Opsion",
    "business.services.search": "Kërko",
...
=======
    ...
    "business.venues.editVenue": "Përditëso Ambientin",
    "business.venues.editVenueDescription": "Përditësoni detajet e ambientit më poshtë",
    "business.venues.name": "Hapësirë Loft Mahnitëse me Pamje nga Qyteti",
    "business.venues.description": "Kjo hapësirë mahnitëse loft ofron pamje mahnitëse të horizontit të qytetit. Me dritare nga dyshemeja në tavan, mure me tulla të ekspozuara dhe pajisje moderne, është perfekte për fotografi, evente korporative dhe mbledhje intime.",
    "business.venues.type": "Lloj",
    "common.hourly": "Çdo Orë",
    "business.venues.minCapacity": "Kapaciteti Minimal",
    "business.venues.maxCapacity": "Kapaciteti Maksimal",
    "business.venues.recommendedCapacity": "Kapaciteti i Rekomanduar",
    "business.venues.amenities": "Pajisjet",
    ...
    "venues.amenities.av_equipment": "Pajisje AV",
...
>>>>>>> Stashed changes
    ...
    "common.status.inactive": "Pasiv",
    "common.featured": "E Rekomanduara",
    "common.popular": "E Popullare",
    "common.filter": "Filtrime",
