                ...
                <div className="space-y-8">
                    <div className="text-center space-y-4">
                        <h1 className="text-3xl md:text-4xl font-bold text-foreground">
                            {language === "sq" ? "Terma dhe Kushte" : "Terms and Conditions"}
                        </h1>
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-lg font-semibold text-foreground mb-3">
                                        {language === "sq" ? "1. Përcaktime" : "1. Definitions"}
                                    </h3>
                                    <ul className="space-y-2 text-muted-foreground">
                                        <li>
                                            <strong className="text-foreground">{language === "sq" ? "Platforma" : "Platform"}:</strong>{" "}
                                            {language === "sq"
                                        ...
                                        <li>
                                            <strong className="text-foreground">
                                                {language === "sq" ? "Klient/Përdorues" : "Client/User"}:
                                            </strong>{" "}
                                            {language === "sq"
                                        ...
                                        <li>
                                            <strong className="text-foreground">
                                                {language === "sq" ? "Ofertuesi i Ambientit" : "Venue Provider"}:
                                            </strong>{" "}
                                            {language === "sq"
                                        ...
                                        <li>
                                            <strong className="text-foreground">{language === "sq" ? "Rezervim" : "Booking"}:</strong>{" "}
                                            {language === "sq"
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-foreground mb-3">
                                        {language === "sq" ? "6. Anulimi" : "6. Cancellation"}
                                    </h3>
                                    <ul className="space-y-2 text-muted-foreground ml-4">
                                        <li>
                                            •{" "}
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-foreground mb-3">
                                        {language === "sq" ? "8. Privatësia" : "8. Privacy"}
                                    </h3>
                                    <ul className="space-y-2 text-muted-foreground ml-4">
                                        <li>
                                            •{" "}
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-6">
                                        ...
                                        <table className="w-full text-sm">
                                            ...
                                            <tr>
                                                <td className="py-2 text-muted-foreground">
                                                    {language === "sq" ? "Deri në 10 persona" : "Up to 10 people"}
                                                </td>
                                                <td className="py-2 text-muted-foreground">1,000 lek</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 text-muted-foreground">
                                                    {language === "sq" ? "Deri në 20 persona" : "Up to 20 people"}
                                                </td>
                                                <td className="py-2 text-muted-foreground">2,000 lek</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 text-muted-foreground">
                                                    {language === "sq" ? "Deri në 30 persona" : "Up to 30 people"}
                                                </td>
                                                <td className="py-2 text-muted-foreground">3,000 lek</td>
                                            </tr>
                                            <tr>
                                                <td className="py-2 text-muted-foreground">
                                                    {language === "sq" ? "30+ persona" : "30+ people"}
                                                </td>
                                                <td className="py-2 text-muted-foreground">
                                                    {language === "sq"
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-foreground mb-3">
                                        {language === "sq"
                                            ? "9. Ligji i Zbatueshëm dhe Juridiksioni"
