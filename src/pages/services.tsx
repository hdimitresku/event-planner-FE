...
import { Utensils, Music, Palette, Camera, Video, Car, Shield, Users, Check, Layers } from "lucide-react"
  ...
  return (
      <div className="relative min-h-screen bg-background">
        ...
        <div className="relative z-10">
          <section className="relative w-full py-16 md:py-24 lg:py-32 overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-stone-100 dark:from-background dark:to-muted/70">
          ...
          <section className="w-full py-16 md:py-24 lg:py-32 bg-gradient-to-br from-stone-100 via-amber-50 to-orange-50 dark:from-background dark:to-muted/70" >
            <div className="container px-4 md:px-6">
              <div className="grid gap-16">
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="inline-flex items-center px-3 py-1 text-sm font-medium text-amber-600 dark:text-amber-400 bg-amber-100 dark:bg-amber-900/40 rounded-full">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 md:text-lg">{t("services.catering.description")}</p>
                    <div className="grid gap-4">
                      <div className="flex items-start gap-3">
                        <div className="h-6 w-6 rounded-full bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center mt-0.5">
                          <Check className="h-4 w-4 text-amber-500 dark:text-amber-400" />
                        </div>
                        <div>
                          <h3 className="font-semibold text-gray-800 dark:text-gray-50">
                            {t("services.catering.option1")}
                          </h3>
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.catering.option1.description")}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-800 dark:text-gray-50">
                            {t("services.catering.option2")}
                          </h3>
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.catering.option2.description")}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-800 dark:text-gray-50">
                            {t("services.catering.option3")}
                          </h3>
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.catering.option3.description")}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 md:text-lg">{t("services.music.description")}</p>
                    <div className="grid gap-4">
                      <div className="flex items-start gap-3">
                        <div className="h-6 w-6 rounded-full bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center mt-0.5">
                          <Check className="h-4 w-4 text-amber-500 dark:text-amber-400" />
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.music.option1.description")}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.music.option2.description")}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.music.option3.description")}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                  <div className="space-y-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 md:text-lg">{t("services.decor.description")}</p>
                    <div className="grid gap-4">
                      <div className="flex items-start gap-3">
                        <div className="h-6 w-6 rounded-full bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center mt-0.5">
                          <Check className="h-4 w-4 text-amber-500 dark:text-amber-400" />
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.decor.option1.description")}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.decor.option2.description")}
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 dark:text-gray-300">
                            {t("services.decor.option3.description")}
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <section className="w-full py-16 md:py-24 lg:py-32 bg-gradient-to-br from-orange-50 via-amber-50 to-stone-100 dark:from-background dark:to-muted/70">
            <div className="container px-4 md:px-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                <Card className="venue-card bg-gray-100 dark:bg-secondary/30 border border-gray-100 dark:border-secondary/30 shadow-sm hover:shadow-md transition-all duration-200">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-semibold text-gray-800 dark:text-gray-50">
                      {t("services.additional.photography")}
                    </h3>
                ...
                <Card className="venue-card bg-gray-100 dark:bg-secondary/30 border border-gray-100 dark:border-secondary/30 shadow-sm hover:shadow-md transition-all duration-200">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-semibold text-gray-800 dark:text-gray-50">
                      {t("services.additional.videography")}
                    </h3>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                ...
                <Card className="venue-card bg-gray-100 dark:bg-secondary/30 border border-gray-100 dark:border-secondary/30 shadow-sm hover:shadow-md transition-all duration-200">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    ...
                    <h3 className="font-semibold text-gray-800 dark:text-gray-50">
                      {t("services.additional.transportation")}
                    </h3>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                ...
                <div className="space-y-2 max-w-3xl">
                  ...
                  <p className="max-w-[900px] text-gray-800 dark:text-gray-50 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    {t("services.cta.description") ||
                        "Ready to create an unforgettable event? Browse our venues and start planning today."}
                  </p>
                </div>
