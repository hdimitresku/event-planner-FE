  ...
  return (
      <div className="relative min-h-screen bg-background">
        ...
        <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="order-1 md:order-2 rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-700">
                    <div className="relative">
                      ...
                      <div className="absolute bottom-4 left-4 bg-white dark:bg-secondary-800 rounded-lg px-3 py-1 text-sm font-medium text-gray-800 dark:text-gray-50 shadow-sm">
          ...
          <section className="w-full py-16 md:py-24 bg-gradient-to-b from-muted to-background/30">
            <div className="container px-4 md:px-6">
              <div className="grid gap-8 lg:grid-cols-2 lg:gap-12 items-center">
                <div
                    className="relative aspect-video overflow-hidden rounded-xl shadow-lg border border-gray-100 dark:border-gray-700">
                  {faqImages.map((item) => (
                      <div
                          key={item.id}
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
                        <div
                            className="absolute bottom-4 left-4 bg-white dark:bg-secondary-800 rounded-lg px-3 py-1 text-sm font-medium text-gray-800 dark:text-gray-50 shadow-sm">
                ...
                <div className="space-y-6">
                  <div
                      className="inline-flex items-center px-3 py-1 text-sm font-medium text-amber-600 dark:text-amber-400 bg-amber-100 dark:bg-amber-900/40 rounded-full mb-2">
                  ...
                  >
                    <AccordionItem value="item-1" className="border-b border-gray-200 dark:border-gray-700">
                      <AccordionTrigger
                          className="text-gray-800 dark:text-gray-50 font-medium hover:text-amber-500 dark:hover:text-amber-400">
                        {t("howItWorks.faq.q1")}
                      </AccordionTrigger>
          ...
          <section className="w-full py-16 md:py-24 lg:py-32 bg-secondary-700/30 ">
            <div className="container px-4 md:px-6">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2 max-w-3xl">
