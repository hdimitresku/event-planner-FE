          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="p-0">
              <div className="grid divide-y">
                ...
                <Link to="/profile" className="flex items-center p-3 hover:bg-muted">
                  <User className="mr-2 h-4 w-4 text-muted-foreground" />
                  <span className="text-sm">{t("dashboard.profile") || "Profile"}</span>
                </Link>
                <Link to="/favorites" className="flex items-center p-3 hover:bg-muted">
                  <Heart className="mr-2 h-4 w-4 text-muted-foreground" />
                  <span className="text-sm">{t("dashboard.favorites") || "Favorites"}</span>
                </Link>
                <Link to="/messages" className="flex items-center p-3 hover:bg-muted">
                  <MessageCircle className="mr-2 h-4 w-4 text-muted-foreground" />
                  <span className="text-sm">{t("dashboard.messages") || "Messages"}</span>
                </Link>
                <Link to="/payment-methods" className="flex items-center p-3 hover:bg-muted">
